...
describe("timetable", () => {
    it("renders expected alert for empty stages", () => {
        render(<Timetable stages={[]} departure={""} minutesPerKm={2} climbPerHour={100} excelExport={() => {}} />);
    ...
    it("renders expected number of rows for given events", () => {
        render(<Timetable stages={stages} minutesPerKm={2} climbPerHour={100} departure={"2022-08-07 12:45"} />);
